...
const articles = [
  ...
  'kitajima-kosuke-childhood',
  'fukuhara-ai-childhood',
  'miyazato-ai-childhood',
  'nakamura-shunsuke-childhood',
  'ishikawa-kasumi-childhood',
  'abe-hifumi-childhood',
  'abe-uta-childhood',
  'hashimoto-daiki-childhood',
  'harimoto-tomokazu-childhood',
  'hayata-hina-childhood',
  'sakamoto-kaori-childhood',
  'hachimura-rui-childhood',
  'takahashi-ran-childhood',
  'nakayama-funa-childhood',
  'seto-daiya-childhood',
  'murakami-munetaka-childhood',
  'suzuki-seiya-childhood',
  'darvish-yu-childhood',
  'kikuchi-yusei-childhood',
  'badminton-aptitude',
  'baseball-aptitude',
  'judo-aptitude',
  'table-tennis-aptitude',
  'tennis-aptitude',
  'volleyball-aptitude',
  'age-3-sports',
  'age-4-sports',
